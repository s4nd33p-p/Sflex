...
#define PACKAGE_STRING "slurm 23.02"
...
/* API current version */
#define SLURM_API_CURRENT 39

/* API current major */
#define SLURM_API_MAJOR 39

/* API current rev */
#define SLURM_API_REVISION 0

/* Define the API's version */
#define SLURM_API_VERSION 0x270000
