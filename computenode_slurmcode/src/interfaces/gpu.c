...
typedef struct slurm_ops {
	...
	int (*volatile_util) (int gpuid, acct_gather_data_t *data);
...
extern int gpu_g_volatile_util(int gpuid, acct_gather_data_t *data)
{
	xassert(g_context);
	return (*(ops.volatile_util))(gpuid, data);
